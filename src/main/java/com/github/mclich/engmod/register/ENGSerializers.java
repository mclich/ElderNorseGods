...
public abstract class ENGSerializers
{
	...
	public static final RegistryObject<RecipeSerializer<?>> BREWERY_SERIALIZER=ENGSerializers.SERIALIZERS.register(BrewingRecipe.ID, BrewingRecipeSerializer::new);
}