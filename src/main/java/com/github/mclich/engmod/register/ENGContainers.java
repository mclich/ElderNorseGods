...
public abstract class ENGContainers
{
	...
	public static final RegistryObject<MenuType<BreweryContainer>> BREWERY_CONTAINER=ENGContainers.CONTAINERS.register(BreweryBlock.ID, ()->IForgeContainerType.create(BreweryContainer::new));
}